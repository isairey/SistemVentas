...
<div class="panel-body" id="formularioregistros">
  <form action="credito1.php" name="formulario" id="formulario" method="POST">
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Marca del articulo(*):</label>
      <input class="form-control" type="hidden" name="mar" id="id">
      <input class="form-control" type="text" name="mar" id="id" maxlength="100" placeholder="Marca" required>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Codigo(*):</label>
      <input class="form-control" type="hidden" name="cod" id="id">
      <input class="form-control" type="text" name="cod" id="id" maxlength="100" placeholder="Credito" required>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Cantidad(*):</label>
      <input class="form-control" type="hidden" name="can" id="id">
      <input class="form-control" type="text" name="can" id="id" maxlength="100" placeholder="Cantidad" required>
    </div>
    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <button class="btn btn-primary" type="submit" id="btnGuardar"><i class="fa fa-save"></i>  Comprar</button>
