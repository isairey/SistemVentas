...
else if($alu['cantidad']>= $retiro && $retiro<=3 && $alu['id_articulo']==$id){
...
$consulta="UPDATE articulos SET cantidad=$resta WHERE id_articulo='$id'";
...
$fec=$_POST['fec'];
 ...
 echo " "."<br>";   
$consulta=$conexion->prepare('INSERT INTO ventas (id_venta,total,id_articulo,cantidad,fecha) VALUES (null,:tot,:id,:can,:fec)');
