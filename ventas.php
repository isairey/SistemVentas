...
$consulta=$conexion->prepare('SELECT * FROM ventas ');
$consulta->execute();
?>
<DOCTYPE html>
  <html>
...
<div class="box-header with-border">
  <h1 class="box-title">Usuarios <button class="btn btn-success"  id="btnagregar"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
